...
urlpatterns = patterns('',
    ...
    (r'^(?P<document_id>[^/]*)/data/get/(?P<format>[^/]*)$', "cliqueclique_ui_document.views.get_document_local_data"),
    (r'^(?P<document_id>[^/]*)/data/set$', "cliqueclique_ui_document.views.set_document_local_data"),
